...
public class MqConfig {
     ...
     */
    public static final String TOPIC = "beiquan-light";
    public static final String PRODUCER_ID = "PID-light";
    public static final String CONSUMER_ID = "CID-light";
    ...
    public static final String ACCESS_KEY = "LTAIxb73vEUP4BD7";
    public static final String SECRET_KEY = "Q9cM21FFt9ERkOWKNemkJl0mQO8eJI";
    public static final String TAG = "beiquan-light-mq";
    /**
