 ...
 */
package com.hjzgg.test;

import com.aliyun.openservices.ons.api.*;
import com.aliyun.openservices.ons.api.transaction.LocalTransactionChecker;
import com.aliyun.openservices.ons.api.transaction.TransactionProducer;
import com.aliyun.openservices.ons.api.transaction.TransactionStatus;
import com.hjzgg.mq.MqConfig;
...
public class MQTest {
     ...
     */
    private static final String TOPIC = MqConfig.TOPIC;
    private static final String PRODUCER_ID = MqConfig.PRODUCER_ID;
    private static final String CONSUMER_ID = MqConfig.CONSUMER_ID;
    private static final String ACCESS_KEY = MqConfig.ACCESS_KEY;
    private static final String SECRET_KEY = MqConfig.SECRET_KEY;
    private static final String TAG = MqConfig.TAG;
    private static final String ONSADDR = MqConfig.ONSADDR;
    ...
    static {
         ...
         */
        {
            ...
            tranProducerProperties.setProperty(PropertyKeyConst.ONSAddr, ONSADDR);
    ...
    public void testSendTranMsg() {
        ...
        SendResult sendResult = transactionProducer.send(msg, (message, o) -> {
